 ...
 */
export function getHost1Name(config: WeddingConfig): string {
 ...
 */
export function getHost2Name(config: WeddingConfig): string | undefined {
 ...
 */
export function getHostsLabel(config: WeddingConfig): string {
